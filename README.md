...
🚀 Project Overview
Manual contract compliance review is time-consuming, error-prone, and difficult to scale. This project automates the entire compliance lifecycle using Large Language Models (LLMs).
